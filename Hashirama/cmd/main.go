...
import (
	...
	"github.com/example/hashirama/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a686ca57.starknet.l3",
	...
	if err := (&controller.MadaraChainReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "MadaraChain")
		os.Exit(1)
	}
